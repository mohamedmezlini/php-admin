    ...
    <section class="main">
        <div class="container">
            ...
            <div class="main__form">
                <div class="main__form--title text-center">Se connecter</div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col col-12">
                            ...
                            <?php if ( isset( $_REQUEST['error'] ) ) {
                                    echo "<h5 class='text-center' style='color:red;'>L'e-mail, le mot de passe et le rôle ne correspondent pas ou incorrecte</h5>";
                            }?>
                        <div class="col col-12">
